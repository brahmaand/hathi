...
public class Config
{
    ...
    public void LoadProperties()
    {
        ...
        if (!LoadPropertiesFromStream(this._configDirectory + Path.DirectorySeparatorChar + this._fileName))
        {
    ...
    public void SaveProperties()
    {
        ...
        WritePropertiesToFile(_configDirectory + _fileName);
    }
    ...
    protected void WritePropertiesToFile(string fileName)
    {
        lock (this)
        {
            try
            {
                ...
                doc.Save(this._configDirectory + Path.DirectorySeparatorChar + this._fileName);
            }
            catch (Exception e)
            {
