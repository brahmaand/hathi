...
//                                                      new Point(img.Left,img.Top)});
                ...
                g.DrawLines(m_ArrowPen,new Point[] {
    ...
    {
        get {
            return ownerDrawHeader;
        }
        set {
            ownerDrawHeader = value;
        }
    }
    ...
    {
        get {
            return defaultCustomDraw;
        }
        set {
            defaultCustomDraw = value;
        }
    }
...
//          return"";
    ...
    protected string PriorityToString(Types.Constants.Priority priority)
    {
        switch (priority)
        {
        case Types.Constants.Priority.VeryHigh:
            return HathiForm.Globalization["LBL_VERYHIGH"];
        case Types.Constants.Priority.High:
            return HathiForm.Globalization["LBL_HIGH"];
        case Types.Constants.Priority.Normal:
            return HathiForm.Globalization["LBL_NORMAL"];
        case Types.Constants.Priority.Low:
            return HathiForm.Globalization["LBL_LOW"];
        case Types.Constants.Priority.VeryLow:
            return HathiForm.Globalization["LBL_VERYLOW"];
        }
        return "";
    }
    protected string ServerPriorityToString(Types.Constants.ServerPriority priority)
    {
        switch (priority)
        {
        case Types.Constants.ServerPriority.High:
            return HathiForm.Globalization["LBL_HIGH"];
        case Types.Constants.ServerPriority.Normal:
            return HathiForm.Globalization["LBL_NORMAL"];
        case Types.Constants.ServerPriority.Low:
            return HathiForm.Globalization["LBL_LOW"];
        }
        return "";
    }
