...
namespace Hathi.Client
{
	...
	public class FormOptions : System.Windows.Forms.Form
	{
		...
		private TabPage tabPageKernel;
		private TabPage tabPageInterface;
		private TabPage tabPageRemote;
		...
		private void m_Globalize()
		{
			...
			tabPageKernel.Text = HathiForm.Globalization["LBL_KERNEL"];
			tabPageInterface.Text = HathiForm.Globalization["LBL_INTERFACE"];
			...
			tabPageRemote.Text = HathiForm.Globalization["LBL_REMOTECONTROL"];
		...
		private void InitializeComponent()
		{
			...
			this.tabPageInterface = new TabPage();
			this.tabPageInterface.ShowCloseButton(false);
			...
			this.tabPageKernel = new TabPage();
			this.tabPageKernel.ShowCloseButton(false);
			...
			this.tabPageRemote = new TabPage();
			this.tabPageRemote.ShowCloseButton(false);
			...
			this.tabControl1.AddRange(new TabPage[] {
			      this.tabPageKernel,
			      this.tabPageInterface,
			      this.tabPageRemote
			  });

			this.tabPageKernel.Activate();
